...
export default function About() {
  return (
    <section id="about" className="h-auto mb-12 md:mt-16 lg:mt-4">
      <h2 className="uppercase  text-center text-3xl font-bold tracking-widest text-[#5d31b6] dark:text-violet-400">
        About Me
      ...
      <div className="w-full p-2 flex items-center ">
        <div className="max-w-[1240px] m-auto grid md:grid-cols-3 gap-6">
          <div className="col-span-2">
            <p className="py-4 text-gray-600 text-xl tracking-wide font-semibold dark:text-gray-500">
            ...
            <p className="py-2 text-gray-600 text-xl tracking-wide font-semibold dark:text-gray-500">
